...
<html lang="en">
    <head>
        <title>MY FIRST SQL DATABASE</title>
        <meta charset="utf-8">
        <meta name="author" content="Alex Skramstad">
        <meta name="description" content="Display table in sql that displats tbls of course">
